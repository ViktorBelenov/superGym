...
exports.initFeedbackSwiper = exports.initCoachesSwiper = void 0;
var coaches = document.querySelector('.coaches');
var feedback = document.querySelector('.feedback');
var initCoachesSwiper = function initCoachesSwiper() {
  var coachesSwiperContainer = coaches.querySelector('.swiper');
  var nextButton = coaches.querySelector('.swiper-button-next');
  var prevButton = coaches.querySelector('.swiper-button-prev');
...
var initFeedbackSwiper = function initFeedbackSwiper() {
  var feedbackSwiperContainer = feedback.querySelector('.swiper');
  var nextButton = feedback.querySelector('.swiper-button-next');
  var prevButton = feedback.querySelector('.swiper-button-prev');

  // eslint-disable-next-line no-unused-vars, no-undef
  var feedbackSwiper = new Swiper(feedbackSwiperContainer, {
    autoHeight: 'true',
    direction: 'horizontal',
    loop: true,
    navigation: {
...
var memebership = document.querySelector('.membership');
var tabs;
exports.tabs = tabs;
...
},{"./tabs":14}],5:[function(require,module,exports){
"use strict";

var playButton = document.querySelector('.video__play-button');
var videoContainer = document.querySelector('.gym__video-container');
var video = '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initSwiper.initCoachesSwiper)();
  (0, _initSwiper.initFeedbackSwiper)();
...
},{"./init-accordion":2,"./init-swiper":3,"./init-tabs":4,"./init-video":5,"./modules/form-validate/form":8,"./utils/ios-vh-fix":16}],7:[function(require,module,exports){
"use strict";
